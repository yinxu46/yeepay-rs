...
//! | 接口               | CLIENT 方法                       | 说明               |
//! |-------------------|----------------------------------|------------------|
//! | 钱包信息查询        | [`wallet_member_query`](YeepayClient::wallet_member_query)                         | 查询会员钱包账户信息       |
//! | 钱包注册 / 登录     | [`wallet`](YeepayClient::wallet)                                                   | 会员钱包开户 / 登录入口    |
//! | 注销会员钱包        | [`wallet_cancel`](YeepayClient::wallet_cancel)                                     | 注销钱包（需先解绑卡、清零余额） |
//! | 营销红包转账        | [`transfer_b2c_market`](YeepayClient::transfer_b2c_market)                         | 商户向用户钱包转账        |
//! | 营销红包转账查询     | [`transfer_b2c_query`](YeepayClient::transfer_b2c_query)                           | 查询 B2C 转账结果      |
//! | 开通免密支付        | [`free_payment_agreement_request`](YeepayClient::free_payment_agreement_request)    | 签约免密支付           |
//! | 免密支付协议查询     | [`free_payment_agreement_query`](YeepayClient::free_payment_agreement_query)       | 查询免密签约状态         |
//! | 收银台统一下单       | [`order_create`](YeepayClient::order_create)                                       | 创建支付订单，获取收银台      |
//! | 查询订单           | [`order_query`](YeepayClient::order_query)                                          | 查询订单状态与详情         |
//! | 关闭订单           | [`order_close`](YeepayClient::order_close)                                          | 关闭订单              |
//! | 订单退款           | [`order_refund`](YeepayClient::order_refund)                                        | 发起退款（支持部分 / 多次退款） |
//! | 订单退款查询       | [`order_refund_query`](YeepayClient::order_refund_query)                             | 查询退款执行结果          |
//! | 申请订单分账       | [`order_divide_apply`](YeepayClient::order_divide_apply)                             | 发起分账请求           |
//! | 订单分账查询       | [`order_divide_query`](YeepayClient::order_divide_query)                             | 查询分账结果           |
//! | 订单分账资金退回    | [`order_divide_back`](YeepayClient::order_divide_back)                               | 将已分账资金退回分账方      |
//! | 订单分账资金退回查询 | [`order_divide_back_query`](YeepayClient::order_divide_back_query)                   | 查询资金退回结果         |
...
pub struct YeepayClient {
    /// Config
    /// - endpoint: `https://openapi.yeepay.com/yop-center`
    /// - yos_endpoint: `https://yos.yeepay.com/yop-center`
    /// - protocol_version: `yop-auth-v2`
    /// - expired_seconds: `1800`
    /// - app_key: merchant app key
    /// - merchant_no: merchant number
    /// - public_key: yeepay public key
